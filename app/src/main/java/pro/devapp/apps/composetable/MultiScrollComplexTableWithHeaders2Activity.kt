...
import pro.devapp.apps.composetable.table.ComplexMultiScrollTableWithHeadersLite
...
class MultiScrollComplexTableWithHeaders2Activity : AppCompatActivity() {
        ...
        setContent {
            ComposeTableTheme {
                ...
                Surface(color = MaterialTheme.colors.background) {
                    ComplexMultiScrollTableWithHeadersLite(
                        viewModel.tableData,
                        viewModel.isLoading,
                        { _, _ ->
